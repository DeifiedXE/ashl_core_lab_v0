"""Create sandbox-only advisory reordering records from reordered-candidate feedback."""
...
COMMAND = "run-sandbox-candidate-ordering-arbitration-reordered-candidate-feedback-gated-candidate-reordering-minimal-check"
FLOW = "sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_minimal_v0"
PACKAGE_ID = "PKG-Phase0-SandboxCandidateOrderingArbitrationReorderedCandidateFeedbackGatedCandidateReordering-Minimal-v0"
BOUNDARY_INDEX_BEFORE = "2026-06-09-b168"
BOUNDARY_INDEX_AFTER = "2026-06-09-b169"
...
REORDERING_PLANS = {
    "reach_front_item": {
        ...
        "reordering_reason": "record_only_reordered_positive_item_contact_feedback_supports_reach_first",
    },
    "wait_or_observe": {
        "candidate_actions_before_reordering": [
            "reach_front_item",
        ...
        "reordering_reason": "record_only_reordered_wait_context_feedback_supports_observation_first",
    },
    "observe_or_alternative_probe": {
        ...
        "reordering_reason": "record_only_reordered_mismatch_probe_feedback_supports_probe_before_retry",
    },
}
...
def build_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(
    ...
    source = (
        ...
        else build_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_approval_boundary_record()
    )
    source_validation = (
        validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_approval_boundary_record(
            source
    ...
    return {
        ...
        "record_type": "sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_minimal",
        "record_version": "v0",
...
def validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(
    record: dict[str, Any],
) -> dict[str, Any]:
    errors: list[str] = []
...
def run_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_minimal_check() -> dict[str, Any]:
    source_records = (
        run_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_approval_boundary_minimal_check()[
            "valid_records"
        ]
    ...
    valid_records = [
        build_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(source)
        for source in source_records
    ]
    records = [*valid_records, *_invalid_records(valid_records[0], valid_records[1], valid_records[2])]
    validation_results = [
        validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(record)
    ...
    return {
        ...
        "boundary": {
            ...
            "boundary_change_required": True,
            "boundary_reason": "Creates same-session sandbox-only advisory candidate reordering records from b168 approval boundaries.",
        },
        "valid_records": valid_records,
        "validation_results": validation_results,
        "summary": summary,
        "human_summary": {
            "what_was_built": "Reordered-candidate arbitration feedback can now reorder same-session sandbox advisory candidates.",
            "what_changed": "Candidate order changes are recorded for reordered reach, wait, and probe arbitration contexts.",
            ...
            "plain_result": "Reordered feedback can shape the sandbox candidate list, but it still cannot choose the next action.",
        },
...
def _invalid_records(reach: dict[str, Any], wait: dict[str, Any], probe: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    mutate(reach, "source_wrong_boundary_index", ("source_reordering_approval_boundary", "source_boundary_index"), "2026-06-09-b167")
