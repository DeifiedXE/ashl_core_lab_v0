"""Apply reordered-candidate feedback as a same-session sandbox record only."""
...
from .sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_minimal import (
    ...
    build_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record,
    ...
    validate_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record,
)


COMMAND = "run-sandbox-candidate-ordering-arbitration-reordered-candidate-outcome-feedback-application-minimal-check"
FLOW = "sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_minimal_v0"
PACKAGE_ID = "PKG-Phase0-SandboxCandidateOrderingArbitrationReorderedCandidateOutcomeFeedbackApplication-Minimal-v0"
BOUNDARY_INDEX_BEFORE = "2026-06-09-b166"
BOUNDARY_INDEX_AFTER = "2026-06-09-b167"

APPLICATION_EFFECTS = {
    "arbitration_reordered_positive_item_contact_feedback_application": {
        "application_label": "arbitration_reordered_positive_item_contact_feedback_applied_record_only",
        "application_valence": "bounded_positive_application_record",
        "recorded_signal": "reordered_positive_item_contact_feedback_available_for_future_review",
        "interpretation": "The reordered positive item contact feedback is applied to a sandbox record only.",
    },
    "arbitration_reordered_wait_context_observation_feedback_application": {
        "application_label": "arbitration_reordered_wait_context_feedback_applied_record_only",
        "application_valence": "bounded_context_application_record",
        "recorded_signal": "reordered_wait_context_feedback_available_for_future_review",
        "interpretation": "The reordered wait/context observation feedback is applied to a sandbox record only.",
    },
    "arbitration_reordered_mismatch_probe_context_feedback_application": {
        "application_label": "arbitration_reordered_mismatch_probe_feedback_applied_record_only",
        "application_valence": "bounded_probe_application_record",
        "recorded_signal": "reordered_mismatch_probe_feedback_available_for_future_review",
        "interpretation": "The reordered mismatch probe feedback is applied to a sandbox record only.",
    },
}
...
def build_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_record(
    ...
    source = (
        ...
        else build_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record()
    )
    source_validation = (
        validate_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record(
            source
    ...
    return {
        "feedback_application_record_id": (
            f"sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_{scenario}_demo_001"
        ),
        "record_type": "sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_minimal",
        "record_version": "v0",
        ...
        "same_session_feedback_application": {
            ...
            "feedback_application_source": (
                "sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary"
            ),
        ...
        "human_summary": {
            "what_was_created": (
                f"Same-session sandbox reordered feedback application record {application_type} was created."
            ),
            "what_it_means": effect["interpretation"],
            "what_is_blocked": (
                "The application record does not create a feedback loop, reorder candidates, change scores, "
                "create action/execution/outcome observation, write persistence, touch predictors, or prove learning."
            ),
            "plain_result": (
                "The reordered feedback is applied only as a bounded sandbox record; it still cannot change "
                "the next choice."
            ),
        },
...
def validate_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_record(
    record: dict[str, Any],
) -> dict[str, Any]:
    errors: list[str] = []
    ...
    return {
        ...
        "record_only_application": application.get("feedback_application_effect_scope")
...
def run_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_minimal_check() -> dict[
    str, Any
]:
    source_records = (
        run_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_minimal_check()[
    ...
    valid_records = [
        build_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_record(source)
        for source in source_records
    ]
    records = [*valid_records, *_invalid_records(valid_records[0], valid_records[1], valid_records[2])]
    validation_results = [
        validate_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_record(record)
    ...
    return {
        ...
        "boundary": {
            ...
            "boundary_change_required": True,
            "boundary_reason": (
                "Creates same-session sandbox reordered-candidate feedback application records without "
                "changing ordering or behavior."
            ),
        },
        ...
        "human_summary": {
            "what_was_built": (
                "Reordered-candidate arbitration sandbox feedback can now be applied as same-session sandbox records."
            ),
            "what_changed": "Record-only feedback application records are created for the three reordered feedback types.",
            "what_is_blocked": (
                "The application does not create loops, reordering, actions, execution, outcome observations, "
                "persistence, predictor influence, production behavior, or proof claims."
            ),
            "plain_result": (
                "The reordered feedback is marked applied inside a bounded record, but it still cannot "
...
def _invalid_records(reach: dict[str, Any], wait: dict[str, Any], probe: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    mutate(reach, "bad_record_type", ("record_type",), "sandbox_reordered_feedback_application_runtime")
    mutate(reach, "wrong_boundary_after", ("boundary_index_after",), BOUNDARY_INDEX_BEFORE)
    mutate(
        reach,
        "source_not_validated",
        ("source_feedback_application_approval_boundary", "source_validated"),
        False,
    )
    mutate(
        reach,
        "source_wrong_boundary_index",
        ("source_feedback_application_approval_boundary", "source_boundary_index"),
        "2026-06-09-b165",
    )
    mutate(
        reach,
        "source_future_application_not_allowed",
        ("source_feedback_application_approval_boundary", "future_feedback_application_allowed"),
        False,
    )
    mutate(
        reach,
        "source_wrong_scope",
        ("source_feedback_application_approval_boundary", "feedback_application_scope"),
        "production",
    )
    mutate(
        reach,
        "source_bad_application_type",
        ("source_feedback_application_approval_boundary", "candidate_for_future_feedback_application"),
        "unknown",
    )
    mutate(
        reach,
        "source_feedback_already_applied",
        ("source_feedback_application_approval_boundary", "feedback_applied_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_feedback_loop_created",
        ("source_feedback_application_approval_boundary", "feedback_loop_created_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_reordering_created",
        ("source_feedback_application_approval_boundary", "candidate_reordering_created_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_scores_changed",
        ("source_feedback_application_approval_boundary", "candidate_scores_changed_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_next_cycle_changed",
        ("source_feedback_application_approval_boundary", "next_cycle_candidate_ordering_changed_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_action_created",
        ("source_feedback_application_approval_boundary", "new_action_created_in_source_package"),
        True,
    )
    mutate(
        reach,
        "source_execution_created",
        ("source_feedback_application_approval_boundary", "new_execution_created_in_source_package"),
        True,
    )
    ...
    mutate(reach, "wrong_application_source", ("same_session_feedback_application", "feedback_application_source"), "older_line")
    ...
    mutate(
        reach,
        "next_cycle_ordering_changed",
        ("same_session_feedback_application", "next_cycle_candidate_ordering_changed"),
        True,
    )
    ...
    mutate(
        reach,
        "new_outcome_observation_created",
        ("same_session_feedback_application", "new_outcome_observation_created"),
        True,
    )
    mutate(
        wait,
        "future_reordering_boundary_missing",
        ("same_session_feedback_application", "future_candidate_reordering_requires_separate_boundary"),
        False,
    )
    mutate(wait, "future_memory_missing", ("same_session_feedback_application", "future_memory_write_requires_separate_boundary"), False)
    mutate(wait, "future_retention_missing", ("same_session_feedback_application", "future_retention_requires_separate_boundary"), False)
    mutate(
        wait,
        "future_predictor_missing",
        ("same_session_feedback_application", "future_predictor_influence_requires_separate_boundary"),
        False,
    )
...
def _summary(validation_results: list[dict[str, Any]]) -> dict[str, int]:
    ...
    return {
        ...
        "positive_item_feedback_application_count": sum(
            1
            for result in valid
            if result["feedback_application_type"]
            == "arbitration_reordered_positive_item_contact_feedback_application"
        ),
...
def _all_checks_passed(summary: dict[str, int]) -> bool:
    return (
        summary["feedback_application_result_count"] == 48
        and summary["valid_feedback_application_count"] == 3
        and summary["invalid_feedback_application_count"] == 45
