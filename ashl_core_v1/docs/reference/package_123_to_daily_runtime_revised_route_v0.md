...
| 142 | Specialized Thought Bounded Rules | critical_path | Package 148 | Next: add a separately bounded specialized rule family with explicit input/output allowlists and cross-family conflict semantics. |
