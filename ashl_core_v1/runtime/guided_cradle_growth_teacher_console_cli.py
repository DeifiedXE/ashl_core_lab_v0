...
from ashl_core_v1.runtime.guided_cradle_growth_teacher_console import (
    ...
    show_host_body_existing_learning_pipeline_approved_replay_demo_from_guided_cradle_growth_console,
    show_host_body_existing_learning_pipeline_interesting_demo_from_guided_cradle_growth_console,
    show_host_body_existing_learning_pipeline_mixed_demo_from_guided_cradle_growth_console,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    subparsers.add_parser("host-body-show-existing-learning-pipeline-uncertainty-demo")
    subparsers.add_parser("host-body-show-existing-learning-pipeline-interesting-demo")
    subparsers.add_parser("host-body-show-existing-learning-pipeline-teacher-review-demo")
    subparsers.add_parser("host-body-show-existing-learning-pipeline-approved-replay-demo")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "host-body-show-existing-learning-pipeline-uncertainty-demo":
            return _print_json(
                show_host_body_existing_learning_pipeline_uncertainty_demo_from_guided_cradle_growth_console()
            )
        if args.command == "host-body-show-existing-learning-pipeline-interesting-demo":
            return _print_json(
                show_host_body_existing_learning_pipeline_interesting_demo_from_guided_cradle_growth_console()
            )
        if args.command == "host-body-show-existing-learning-pipeline-teacher-review-demo":
            return _print_json(
                show_host_body_existing_learning_pipeline_teacher_review_demo_from_guided_cradle_growth_console()
            )
        if args.command == "host-body-show-existing-learning-pipeline-approved-replay-demo":
            return _print_json(
                show_host_body_existing_learning_pipeline_approved_replay_demo_from_guided_cradle_growth_console()
            )
        if args.command == "host-body-show-existing-learning-pipeline-mixed-demo":
            return _print_json(
                show_host_body_existing_learning_pipeline_mixed_demo_from_guided_cradle_growth_console()
            )
        if args.command == "host-body-show-existing-learning-pipeline-readiness":
            return _print_json(
                show_host_body_existing_learning_pipeline_readiness_from_guided_cradle_growth_console()
            )
