...
def _ideal_organs() -> tuple[IdealEndStateOrganRecord, ...]:
    rows = (
        ...
        ("Persistent Self-State System", "Maintain opaque structural identity lineage distinct from session, readback, memory and drive.", ("Package 133 immutable lineage", "explicit Package 134 recovery authorization"), ("persistent self-state representation", "active-head identity binding"), "Package 133 representation and Package 134 recovery only; no behavior authority", "external immutable history plus separate active-head CAS", "future Package 137 mutation review gate required", "block on missing, corrupt, stale or ambiguous identity", ("Memory System",), ("Thought Engine", "Daily Session And Recovery System"), "Packages 133-134 structural foundation complete; Packages 137-140 future"),
        ("Mimetic Endocrine Regulation System", "Trace anonymous bounded regulatory observations without purpose or direct action authority; modulation remains future work.", ("explicit bounded local regulatory observations",), ("append-only drive/regulatory source-time-change traces",), "Package 135 trace authority only; no modulation authority", "same-session trace history only; never self-state or recovered drive", "Package 136 requires separate bounded-consumer authorization", "reject authority conflation and reset at session boundary", ("Persistent Self-State System",), ("Thought Engine", "Active Perception And Attention System"), "Package 135 trace boundary complete; Packages 136-140 future"),
...
def _build_gaps_and_bottlenecks(interface_records: tuple[Any, ...]) -> tuple[tuple[ArchitectureCapabilityGapRecord, ...], tuple[ArchitectureBottleneckRecord, ...]]:
    ...
    gaps = (
        ...
        _gap(
            "Persistent self-state representation and recovery lack review and influence gates",
            "missing_interface",
            "Persistent Self-State System",
            ("ashl_core_v1.state.persistent_self_state_schema", "ashl_core_v1.state.persistent_session_recovery_types"),
            "Package 133 immutable representation and Package 134 explicit structural recovery",
            "teacher-gated self-state mutation, readback and rollback without drive or content conflation",
            ("self_state_teacher_gate", "self_state_readback_boundary", "self_state_rollback_audit"),
            ("no behavior influence, drive persistence or psychological-continuity claim exists",),
            ("self-state review, readback equivalence and rollback tests",),
            ("137", "140"),
            "high",
            "Preserve Package 133/134 authority separation while adding only explicitly reviewed future transitions.",
        ),
        _gap(
            "Drive trace exists but same-session modulation remains unauthorized",
            "missing_interface",
            "Mimetic Endocrine Regulation System",
            ("ashl_core_v1.endocrine.drive_signal_trace_types", "ashl_core_v1.endocrine.package_135_drive_signal_trace_store"),
            "Package 135 authoritative trace-only boundary with cross-session reset",
            "separately authorized fail-to-neutral same-session bounded modulation",
            ("allowlisted_drive_modulation_consumer",),
            ("no runtime modulation consumer exists and persistent drive remains forbidden",),
            ("Package 136 authorization, counterfactual, expiry and equivalence tests",),
            ("136", "140"),
            "medium",
            "Preserve Package 135 trace authority and do not promote legacy endocrine fixtures into runtime modulation.",
        ),
        _gap(
