...
- b108-b112 Endocrine / Visual-Spatial Affordance compressed milestone: sandbox-only mimetic endocrine sweetness/cost traces, generic outcome -> internal response modulation preview, body-relative visual spatial position/direction/distance trace, and visual front-cell -> motor affordance preview. Evidence includes candy_contact -> dopamine_like, high sweetness losing to high difficulty/return cost, visible-cell spatial trace, and can_step_forward/can_turn/can_reach/front_blocked/contact affordances. Forbidden: no motor execution, selected_action/final_action/direct command from modulation or vision, semantic vision, object recognition, pathfinding, production behavior, memory/retention write, predictor mutation, persistent endocrine/body schema, subjective/biological/proof claim.
## Archive
- Older milestone details are archived in `docs/boundary_index_archive_2026_06.md`.
