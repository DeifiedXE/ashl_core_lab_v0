...
- No selected_action/final_action/direct-command/execution outside validated sandbox-only scopes. Current validated scopes include the earlier b95-b104 sandbox action/direct-command line, fixed/time-paced sandbox action loops, and the b114-b120 body-motor selected_motor_intent -> selected_action -> final_action -> direct command -> one-step execution -> outcome observation -> feedback/settling -> advisory next-action pressure preview line.
