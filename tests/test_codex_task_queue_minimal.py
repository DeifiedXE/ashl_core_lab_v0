...
class CodexTaskQueueMinimalTests(unittest.TestCase):
    ...
    def test_demo_summary_counts_are_deterministic(self):
        ...
        self.assertEqual(52, summary["valid_task_entry_count"])
        self.assertGreaterEqual(summary["invalid_task_entry_count"], 14)
    ...
    def test_boundary_change_required_false_blocks_version_change(self):
        task = self._task()
        task["boundary_index_version_after"] = "2026-06-09-b102"
    ...
    def _task(self, status="pending", task_type="workflow_only", notes="Test task."):
        task = {
            ...
            "boundary_index_version_before": "2026-06-09-b101",
            "boundary_index_version_after": "2026-06-09-b101",
