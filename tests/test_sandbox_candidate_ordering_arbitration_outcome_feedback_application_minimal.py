...
from ashl_core.sandbox_candidate_ordering_arbitration_outcome_feedback_application_minimal import (
...
class SandboxCandidateOrderingArbitrationOutcomeFeedbackApplicationMinimalTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.sources = run_sandbox_candidate_ordering_arbitration_outcome_feedback_application_approval_boundary_minimal_check()[
            "valid_records"
        ]
        cls.result = run_sandbox_candidate_ordering_arbitration_outcome_feedback_application_minimal_check()
    ...
    def test_valid_feedback_application_records_are_created(self):
        for record in self.records:
            result = validate_sandbox_candidate_ordering_arbitration_outcome_feedback_application_record(record)

            self.assertTrue(result["valid"])
            self.assertEqual(record["record_type"], "sandbox_candidate_ordering_arbitration_outcome_feedback_application_minimal")
    ...
    def test_reach_front_item_feedback_application_record_created(self):
        record = build_sandbox_candidate_ordering_arbitration_outcome_feedback_application_record(self.sources[0])
    ...
    def test_wait_context_feedback_application_record_created(self):
        ...
        result = validate_sandbox_candidate_ordering_arbitration_outcome_feedback_application_record(self.wait)
    ...
    def test_probe_feedback_application_record_created(self):
        ...
        result = validate_sandbox_candidate_ordering_arbitration_outcome_feedback_application_record(self.probe)
    ...
    def test_bad_source_blocks(self):
        ...
        result = validate_sandbox_candidate_ordering_arbitration_outcome_feedback_application_record(bad)
    ...
    def test_demo_summary_counts_are_deterministic(self):
        ...
        self.assertEqual(summary["feedback_application_result_count"], 42)
        self.assertEqual(summary["valid_feedback_application_count"], 3)
        self.assertEqual(summary["invalid_feedback_application_count"], 39)
    ...
    def test_cli_command(self):
        result = run_command("run-sandbox-candidate-ordering-arbitration-outcome-feedback-application-minimal-check")
