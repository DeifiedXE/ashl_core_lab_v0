...
class SandboxCandidateOrderingArbitrationReorderedCandidateFeedbackGatedCandidateReorderingMinimalTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.sources = run_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_approval_boundary_minimal_check()[
            "valid_records"
        ]
        cls.result = run_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_minimal_check()
    ...
    def test_valid_reordering_records_are_created(self):
        for record in self.records:
            result = validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(
                record
            )
            ...
            self.assertEqual(
                record["record_type"],
                "sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_minimal",
            )
    ...
    def test_reach_feedback_prioritizes_reach_front_item(self):
        record = build_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(
            self.sources[0]
        )
        reordering = record["feedback_gated_candidate_reordering"]
        result = validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(record)
    ...
    def test_bad_source_blocks(self):
        ...
        result = validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(bad)
    ...
    def test_primary_not_first_or_same_order_blocks(self):
        ...
        result = validate_sandbox_candidate_ordering_arbitration_reordered_candidate_feedback_gated_candidate_reordering_record(same)
        self.assertFalse(result["valid"])
