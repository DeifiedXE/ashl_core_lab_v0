...
class SandboxCandidateOrderingArbitrationReorderedCandidateOutcomeFeedbackApplicationApprovalBoundaryMinimalTests(
    unittest.TestCase
):
    @classmethod
    def setUpClass(cls):
        cls.sources = run_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_minimal_check()[
            "valid_records"
        ]
        cls.result = (
            run_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_minimal_check()
    ...
    def test_valid_feedback_application_approval_boundaries_are_created(self):
        for record in self.records:
            ...
            self.assertEqual(
                record["record_type"],
                "sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_minimal",
            )
    ...
    def test_default_builder_uses_b165_feedback_source(self):
        record = (
            build_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record()
        )
        source = record["source_feedback_record"]
        result = (
            validate_sandbox_candidate_ordering_arbitration_reordered_candidate_outcome_feedback_application_approval_boundary_record(
                record
            )
        ...
        self.assertTrue(result["valid"])
        self.assertEqual(source["source_boundary_index"], "2026-06-09-b165")
        self.assertTrue(source["feedback_evaluation_created"])
        self.assertFalse(source["feedback_applied"])
    ...
    def test_reach_front_item_feedback_can_enter_future_application(self):
        ...
        self.assertEqual(result["feedback_type"], "arbitration_reordered_positive_item_contact_feedback")
        self.assertEqual(
    ...
    def test_wait_context_feedback_can_enter_future_application(self):
        ...
        self.assertEqual(result["feedback_type"], "arbitration_reordered_wait_context_observation_feedback")
        self.assertEqual(
            boundary["candidate_for_future_feedback_application"],
    ...
    def test_probe_feedback_can_enter_future_application(self):
        ...
        self.assertEqual(result["feedback_type"], "arbitration_reordered_mismatch_probe_context_feedback")
        self.assertEqual(
            boundary["candidate_for_future_feedback_application"],
    ...
    def test_source_without_future_application_boundary_blocks(self):
        bad = copy.deepcopy(self.reach)
        bad["source_feedback_record"]["future_feedback_application_requires_separate_boundary"] = False
        ...
        self.assertFalse(result["valid"])
        self.assertIn("source_future_feedback_application_requires_separate_boundary_not_expected", result["error_codes"])
    ...
    def test_demo_summary_counts_are_deterministic(self):
        ...
        self.assertEqual(summary["feedback_application_approval_boundary_result_count"], 51)
        self.assertEqual(summary["valid_feedback_application_approval_boundary_count"], 3)
        self.assertEqual(summary["invalid_feedback_application_approval_boundary_count"], 48)
